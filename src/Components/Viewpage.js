...
<div className="container">
    <div className="row">
        <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div className="row">
               {viewlist.map((value,key)=>{return <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 col-xxl-3">
               <div className="card" >
  <img src="https://cdn.pixabay.com/photo/2018/04/18/18/56/user-3331256__340.png" className="card-img-top" alt="..."/>
  <div className="card-body">
   <p className="card-text">ID:{value.id}</p>
    ...
    <p className="card-text">STREET:{value.address.street}</p>
    ...
    <p className="card-text">WESITE:{value.website}</p>
    
    <p className="card-text">NAME:{value.company.name}</p>
